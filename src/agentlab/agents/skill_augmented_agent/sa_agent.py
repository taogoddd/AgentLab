...
from .sa_agent_prompt import SkillAugmentedPromptFlags, MainPrompt


@dataclass
class SkillAugmentedAgentArgs(AbstractAgentArgs):
    agent_name: str = "SkillAugmentedAgent"
    chat_model_args: ChatModelArgs = None
    flags: SkillAugmentedPromptFlags = None
    max_retry: int = 4

    def make_agent(self, **kwargs):
        return SkillAugmentedAgent(
            chat_model_args=self.chat_model_args, flags=self.flags, max_retry=self.max_retry
        )


class SkillAugmentedAgent(Agent):
