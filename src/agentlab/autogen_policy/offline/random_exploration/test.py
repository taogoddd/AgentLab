...
path = "/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/explorations/2024-08-15_02-37-43_explore/2024-08-15_02-37-45_Explorer_on_webarena.27_92_9938ad"
window_size = 10
step_size = 5
experience = get_experience_from_exploration(path, window_size, step_size)

# # rewriting mode
# with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/experiences/experiences.pkl", "wb") as f:
...
# with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/experiences_json/experiences.json", "w") as f:
...
with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/experiences/new_experiences.pkl", "rb") as f:
    old_experience = pickle.load(f)
    new_experience = old_experience + experience

# save the appended experience
with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/experiences/new_experiences.pkl", "wb") as f:
...
with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/experiences_json/new_experiences.json", "w") as f:
...
# with open("/home/ubuntu/github/AgentLab/src/agentlab/autogen_policy/offline/random_exploration/state_summaries.json", "w") as f:
