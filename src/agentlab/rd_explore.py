...
def parse_args():
    ...
    parser.add_argument("--num_samples", type=int, default=10, help="Number of times to run the same task")
    ...
    parser.add_argument("--max_exploration_steps", type=int, default=10, help="Maximum number of steps to take for each task.")
